  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={<Button><Network className="h-4 w-4" />Build article</Button>}
      />
      ...
      <EmptyState
        ...
        message={(
          <div>
            <p className="mb-8">Generate SEO-optimized articles by clustering related keywords and topics.</p>
