...
export default function SignUp() {
    ...
    const { call: signUp, loading: signingUp, error: signUpError, reset } = useAsyncCallback(async () => {
            ...
            <div className="w-full max-w-md bg-white rounded-2xl shadow p-6 space-y-6">
                ...
                <div className="space-y-4">
                    ...
                    <Button
                        type="button"
                        onClick={async () => {
                            setMessage(null); setFormError(null); setFieldErrors({}); reset();
                    ...
                    <div className="text-sm text-gray-600">
                        ...
                        <a className="text-brand-600 hover:underline" href={`/login?redirectTo=${encodeURIComponent(redirectTo)}`}>
                            Sign in
                        </a>
                    </div>
                </div>
                ...
                {(formError || signUpError) && (
                    <div className="space-y-2">
                        <div className="text-sm text-red-600">{formError || signUpError?.message}</div>
                    </div>
                )}
            </div>
        </div>
