  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={<Button><Youtube className="h-4 w-4" />Start conversion</Button>}
      />
      ...
      <EmptyState
        ...
        message={(
          <div>
            <p className="mb-8">This tool will extract YouTube transcripts and transform them into SEO-optimized blog posts.</p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600">Automatically pull transcripts</p>
              </div>
              <div className="text-center">
