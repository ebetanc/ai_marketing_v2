      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="flex flex-wrap items-center gap-2 mb-1">
            <span
              className="font-medium text-gray-900 truncate max-w-[24ch]"
              title={company.brand_name || company.name}
            >
          ...
          <div className="flex flex-wrap items-center gap-4 text-base text-gray-500 mt-2">
            ...
            {(company.key_offer || company.brand_voice?.style) && (
              <span className="inline-flex items-center gap-1">
                <Building2 className="h-3 w-3" /> Key Offer
              </span>
            )}
        ...
        <div className="flex items-center">
          <Button
            ...
            aria-label={`Open company ${company.brand_name || company.name}`}
          >
