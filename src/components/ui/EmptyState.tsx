...
export function EmptyState({ icon, title, message, actions, variant = 'brand' }: EmptyStateProps) {
    return (
        <Card>
            <CardContent className="text-center py-16">
                {icon && (
                    <div className={`w-16 h-16 bg-gradient-to-br ${variantMap[variant]} rounded-2xl flex items-center justify-center mx-auto mb-6`}>
                        {icon}
                    </div>
                )}
