      ...
      >
        {isOpen && (
          <motion.div
            ...
            className={
              backdropClassName ||
              "fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4 z-[9999]"
            }
...
export function ModalFooter({ className, ...props }: ModalSectionProps) {
  return (
    <div
      className={cn(
        "flex items-center justify-end space-x-3 p-6 border-t border-gray-200 bg-gray-50 flex-shrink-0",
        className,
      )}
      {...props}
    />
