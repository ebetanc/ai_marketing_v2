  ...
  return (
      ...
      className={cn(
        "inline-flex items-center justify-center gap-2 rounded-xl font-medium motion-safe:transition-all motion-safe:duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-white disabled:cursor-not-allowed disabled:opacity-60",
        {
          "bg-brand-600 text-white hover:bg-brand-700 focus-visible:ring-brand-500 disabled:bg-brand-400":
            variant === "primary",
          "bg-gray-100 text-gray-900 hover:bg-gray-200 focus-visible:ring-gray-500 disabled:bg-gray-100":
            variant === "secondary",
          // Outline: stronger border and clearer hover on light/tinted surfaces; explicit disabled styles
          "border-2 border-gray-300 bg-white text-gray-900 hover:bg-gray-50 focus-visible:ring-gray-600 disabled:text-gray-400 disabled:border-gray-200 disabled:bg-white":
            variant === "outline",
          // Ghost: darker default text and clearer hover background for contrast on gray surfaces
          "text-gray-800 hover:text-gray-900 hover:bg-gray-100 focus-visible:ring-gray-600":
            variant === "ghost",
    ...
    >
      {loading && (
        <svg
          aria-hidden="true"
          className="motion-reduce:animate-none animate-spin h-4 w-4"
          fill="none"
          viewBox="0 0 24 24"
        >
          <circle
