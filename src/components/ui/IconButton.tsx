  ...
  return (
    <button
      ...
      className={cn(
        ...
        // variants
        variant === "default" &&
          "text-gray-600 hover:text-gray-900 hover:bg-gray-100 focus-visible:ring-brand-500",
        variant === "ghost" &&
          "text-gray-700 hover:text-gray-900 hover:bg-gray-100 focus-visible:ring-gray-500",
        variant === "danger" &&
